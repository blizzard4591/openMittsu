 ...
 */
void sha2_hmac_update(sha2_context* ctx, unsigned char const* input, size_t ilen) {
	sha2_update(ctx, input, ilen);
}
 ...
 */
void sha2_hmac(unsigned char const* key, size_t keylen, unsigned char const* input, size_t ilen, unsigned char output[32], int is224) {
	sha2_context ctx;
