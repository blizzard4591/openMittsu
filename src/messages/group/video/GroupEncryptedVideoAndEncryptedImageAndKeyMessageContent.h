#ifndef OPENMITTSU_MESSAGES_GROUP_GROUPENCRYPTEDVIDEOANDENCRYPTEDIMAGEANDKEYMESSAGECONTENT_H_
#define OPENMITTSU_MESSAGES_GROUP_GROUPENCRYPTEDVIDEOANDENCRYPTEDIMAGEANDKEYMESSAGECONTENT_H_
...
namespace openmittsu {
	namespace messages {
		namespace group {
			...
			class GroupEncryptedVideoAndEncryptedImageAndKeyMessageContent : public GroupMessageContent {
			public:
				GroupEncryptedVideoAndEncryptedImageAndKeyMessageContent(openmittsu::protocol::GroupId const& groupId, QByteArray const& encryptedVideo, QByteArray const& encryptedImage, openmittsu::crypto::EncryptionKey const& encryptionKey, quint16 lengthInSeconds, quint32 videoSizeInBytes, quint32 imageSizeInBytes);
				virtual ~GroupEncryptedVideoAndEncryptedImageAndKeyMessageContent();
...
#endif // OPENMITTSU_MESSAGES_GROUP_GROUPENCRYPTEDVIDEOANDENCRYPTEDIMAGEANDKEYMESSAGECONTENT_H_
