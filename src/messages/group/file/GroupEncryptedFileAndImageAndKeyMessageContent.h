#ifndef OPENMITTSU_MESSAGES_GROUP_GROUPENCRYPTEDFILEANDIMAGEANDKEYMESSAGECONTENT_H_
#define OPENMITTSU_MESSAGES_GROUP_GROUPENCRYPTEDFILEANDIMAGEANDKEYMESSAGECONTENT_H_
...
namespace openmittsu {
	namespace messages {
		namespace group {
			...
			class GroupEncryptedFileAndImageAndKeyMessageContent : public GroupMessageContent {
			public:
				GroupEncryptedFileAndImageAndKeyMessageContent(openmittsu::protocol::GroupId const& groupId, QByteArray const& encryptedFile, QByteArray const& imageData, openmittsu::crypto::EncryptionKey const& encryptionKey, QString const& mimeType, QString const& fileName, QString const& caption, quint64 fileSizeInBytes);
				virtual ~GroupEncryptedFileAndImageAndKeyMessageContent();
...
#endif // OPENMITTSU_MESSAGES_GROUP_GROUPENCRYPTEDFILEANDIMAGEANDKEYMESSAGECONTENT_H_
