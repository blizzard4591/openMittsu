...
namespace openmittsu {
	namespace messages {
		...
		MessageFlags MessageFlagsFactory::createContactMessageFlags() {
			return MessageFlags(true, false, false, false, false, false, false);
		}

		MessageFlags MessageFlagsFactory::createGroupTextMessageFlags() {
			return MessageFlags(true, false, false, false, false, true, false);
		}

		MessageFlags MessageFlagsFactory::createGroupControlMessageFlags() {
			return MessageFlags(false, false, false, false, false, true, false);
		}

		MessageFlags MessageFlagsFactory::createTypingStatusMessageFlags() {
			return MessageFlags(false, true, true, false, false, false, false);
		}

		MessageFlags MessageFlagsFactory::createReceiptMessageFlags() {
			return MessageFlags(false, false, false, false, false, false, false);
		}
