#ifndef OPENMITTSU_MESSAGES_CONTACT_CONTACTENCRYPTEDVIDEOANDIMAGEIDANDKEYMESSAGECONTENT_H_
#define OPENMITTSU_MESSAGES_CONTACT_CONTACTENCRYPTEDVIDEOANDIMAGEIDANDKEYMESSAGECONTENT_H_
...
namespace openmittsu {
	namespace messages {
		namespace contact {
			...
			class ContactEncryptedVideoAndImageIdAndKeyMessageContent : public ContactMessageContent {
			public:
				ContactEncryptedVideoAndImageIdAndKeyMessageContent(QByteArray const& encryptedVideo, QByteArray const& imageBlobId, openmittsu::crypto::EncryptionKey const& encryptionKey, quint16 lengthInSeconds, quint32 videoSizeInBytes, quint32 imageSizeInBytes);
				virtual ~ContactEncryptedVideoAndImageIdAndKeyMessageContent();
...
#endif // OPENMITTSU_MESSAGES_CONTACT_CONTACTENCRYPTEDVIDEOANDIMAGEIDANDKEYMESSAGECONTENT_H_
